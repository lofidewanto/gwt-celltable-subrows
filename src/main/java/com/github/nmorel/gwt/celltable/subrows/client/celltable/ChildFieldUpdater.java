 ...
 * @author NICOLASM
 */
public class ChildFieldUpdater<P, C, V> implements FieldUpdater<P, V> {
	...
	public ChildFieldUpdater(int childIndex, ChildGetter<P, C> childGetter,
	...
	public void update(int index, P parent, V value) {
		fieldUpdater
				.update(index, childGetter.getChild(parent, childIndex), value);
	}
}
