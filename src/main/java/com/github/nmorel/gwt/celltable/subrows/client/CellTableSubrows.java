 ...
 */
public class CellTableSubrows implements EntryPoint {
	...
	interface Binder extends UiBinder<Widget, CellTableSubrows> {
	}
	...
	public void onModuleLoad() {
		table = new DataGrid<Parent>(Integer.MAX_VALUE,
				GWT.<CellTableResources>create(CellTableResources.class));
		...
		ListDataProvider<Parent> dataProvider = new ListDataProvider<Parent>(
				datas);
	...
	private void createDeployableColumn() {
		Column<Parent, String> column = new Column<Parent, String>(
	...
	private void createNumberColumn() {
		Column<Parent, ?> column = new Column<Parent, Number>(
				tableBuilder.createNumberCell()) {
			@Override
	...
	private void createDateColumn() {
		Column<Parent, Date> column = new Column<Parent, Date>(
				tableBuilder.createDateCell()) {
			@Override
